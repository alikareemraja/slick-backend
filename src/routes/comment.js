...
router.post('/vote/:commentId/:vote', middlewares.checkAuthentication, CommentController.vote); // get a thread owned items
router.get('/get/user/:userId', middlewares.checkAuthentication, CommentController.getUserDetails); // get a thread owned items
